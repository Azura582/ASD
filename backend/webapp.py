...
# 问卷问题列表
QUESTIONS = [
    {"id": "Q1", "text": "当你叫他/她名字的时候，他/她会看着你吗？"},
    {"id": "Q2", "text": "在交谈时，孩子和你有频繁的眼神交流吗？"},
    {"id": "Q3", "text": "当他/她想要一个东西时，他/她会指着这个东西吗？"},
    {"id": "Q4", "text": "他/她会和你分享他/她感兴趣的东西吗?"},
    {"id": "Q5", "text": "他/她会假装玩游戏吗(例如,假装从玩具茶杯里喝茶?"},
    {"id": "Q6", "text": "他/她会看向你们目光看向的方向吗？"},
    {"id": "Q7", "text": "如果他/她身边的某人表现出明显悲伤的情绪，他/她是否会有安慰那个人的表现?"},
    {"id": "Q8", "text": "他/她学会说话是不是比较晚?"},
    {"id": "Q9", "text": "他/她可以做出一些简单的动作吗?例如摆手说再见和点头同意。"},
    {"id": "Q10", "text": "你的孩子会无目的性的盯着一些东西看吗？"}
]
